...
def precompute_bayes_limits(threshold_sigma):
    ...
    np.savetxt(f'/home/erwan/Documents/GitHub/EXOD2/exod/utils/bayesfactorlimits_{threshold_sigma}.txt', data)

def load_precomputed_bayes_limits(threshold_sigma):
    """Loads the precomputed Bayes factor limit numbers, for a chosen threshold. """
    data = np.loadtxt(f'/home/erwan/Documents/GitHub/EXOD2/exod/utils/bayesfactorlimits_{threshold_sigma}.txt')
    range_mu = data[0]
